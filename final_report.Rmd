...
After gaining an initial understanding of the data trends, we employed both stepwise selection and regularization techniques like LASSO and Ridge Regression for selecting the most appropriate model.<br>
...
knitr::kable(x = backward_model_table, caption = "Table 5: Backward Model Summary", digits = 3)
```
...
knitr::kable(x = forward_model_2table, caption = "Table 6: Forward Model Summary", digits = 3)
```
...
knitr::kable(x = lasso_table, caption = "Table 7: Lasso Model Summary", digits = 3)
```
...
knitr::kable(x = ridge_table, caption = "Table 8: Ridge Regression Summary", digits = 3)
```
